    ...
    try:
        with socket.socket(socket.AF_INET, socket.SOCK_STREAM) as sock:
            ...
            email_body = (
                ...
                "To: pas2017@interia.pl\r\n"
                "Subject: Test email from ex-05 (Image Attachment)\r\n"
                "MIME-Version: 1.0\r\n"
                ...
                "\r\n"
                "Hello, this is a test message with an image attachment.\r\n"
                "--sep\r\n"
                'Content-Type: image/png; name="dummy.png"\r\n'
